...
BPE is one of the most widely used tokenization methods in modern LLMs, used by models like GPT-2, GPT-3, and GPT-4. How it works:
...
<img src="https://github.com/mkader/AI-Notes/blob/bdae3499e57093d24d77f0a5c097a24b62beff36/llm/How%20LLMs%20See%20the%20World_2.jpg">

### 2. WordPiece
WordPiece was introduced by Google and is used in models like BERT, DistilBERT, and Electra. How it works:
...
### 3. SentencePiece
SentencePiece is a tokenizer developed by Google that works directly on raw text without requiring language-specific pre-tokenization. It’s used in models like T5, XLNet, and ALBERT. How it works:
...
### 4. Unigram
Unigram is often used together with SentencePiece and takes a probabilistic approach rather than a merge-based one. How it works:
...
<img src="https://github.com/mkader/AI-Notes/blob/288e7b4462876ac827c7df25c57afde63fc56d79/llm/How%20LLMs%20See%20the%20World_3.jpg">
